...
subtitle: "v0.2 polished case-study preprint candidate"
author: "Anton Sokolov"
affiliation: "Tyche Institute, Tallinn, Estonia"
date: "2026-05-27"
version: "v0.2 polished case-study preprint candidate"
...
integrity and legal interpretation. Across four dated local/public
...
under the configured method, four EATF-verified package receipts, and
five public dashboard cards. Synthetic fixtures cover stable/no-change
...
| EATF/AEP | evidence-attestation framework / Agent Evidence Package | Evidence-envelope and receipt layer. |
...
The public observatory is deployed at the
[Cassandra dashboard](https://cassandra-observatory.pages.dev/). Its
machine-readable index is the
[public JSON index](https://cassandra-observatory.pages.dev/data/index.json).
As of the 2026-05-27 build, the public index reports four runs, latest
date `2026-05-27`, four EATF-verified receipts, and five dashboard
...
Table 3. Package receipt boundary for the 2026-05-27 public card.

| Field | Card value | Interpretation |
|---|---|---|
| Package | `cassandra-observation.aep` | Evidence package for the run. |
| Package hash | prefix `3ef7f33b391a` | Full hash is kept in the machine ledger. |
| Receipt | `eatf-verification.json` | Verification record for the package. |
| Receipt hash | prefix `1e971e12a46b` | Full hash is kept in the machine ledger. |
...
Table 4. Four-run structural-observation telemetry.
...
Table 5. Aggregate structural diff classes across the four runs.
...
Table 6. Fixture classes compressed for print.
...
Table 8. Adjacent case-study roles for the thesis.
...
| eaudit and h2oatlas | Professional/environmental evidence. | Publicness and rights check required. |
| Aletheia and Kolmogorov | Prototype or unresolved inventory items. | Do not cite as adoption or public proof. |
...
Repository: [Tyche Institute Cassandra repository](https://github.com/tyche-institute/cassandra)

Dashboard: [Cassandra observatory](https://cassandra-observatory.pages.dev/)

Public index: [dashboard JSON](https://cassandra-observatory.pages.dev/data/index.json)

\needspace{14\baselineskip}

Table 9. Local artifact groups for this preprint.

| Group | Local files |
|---|---|
| Preprint outputs | `cassandra-preprint-v0.2.md`, PDF, DOCX, and LaTeX header. |
...
| Public evidence | Observatory index, dashboard cards, and 2026-05-27 EATF verification. |
...
[^eatf]: EATF is used here for the project's evidence-attestation
    framework, and AEP for Agent Evidence Package. The phrase means a
