...
"""
    ...
    append_index(
        "notes/append_iteration_20260521T163157.py",
    ...
    tmp = Path("/tmp/cassandra-artifact-index-current-hash-post-20260521T163157Z.json")
    proc = subprocess.run(
