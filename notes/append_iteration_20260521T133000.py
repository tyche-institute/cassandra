#!/usr/bin/env python3
"""Append bounded same-date cadence iteration records for 2026-05-21T13:30:00Z.
...
HELPER = ROOT / "notes/append_iteration_20260521T133000.py"

ENTRY_TS = "2026-05-21T13:30:00Z"
DATE_OUTPUT = "2026-05-21T13:29:59.169833532Z"
...
append(INDEX, index_row(
    "notes/append_iteration_20260521T133000.py",
...
validation_out = Path("/tmp/cassandra-artifact-index-current-hash-post-20260521T133000Z.json")
proc = subprocess.run(
...
final_out = Path("/tmp/cassandra-artifact-index-current-hash-final-20260521T133000Z.json")
