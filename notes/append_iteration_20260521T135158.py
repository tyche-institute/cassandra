#!/usr/bin/env python3
"""Append bounded same-date cadence iteration records for 2026-05-21T13:51:58Z.
...
HELPER = ROOT / "notes/append_iteration_20260521T135158.py"

ENTRY_TS = "2026-05-21T13:51:58Z"
DATE_OUTPUT = "2026-05-21T13:51:58.285598660Z"
...
append(INDEX, index_row(
    "notes/append_iteration_20260521T135158.py",
...
validation_out = Path("/tmp/cassandra-artifact-index-current-hash-post-20260521T135158Z.json")
proc = subprocess.run(
...
final_out = Path("/tmp/cassandra-artifact-index-current-hash-final-20260521T135158Z.json")
