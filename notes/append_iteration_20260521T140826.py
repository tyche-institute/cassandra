#!/usr/bin/env python3
"""Append bounded same-date cadence iteration records for 2026-05-21T14:08:26Z.
...
HELPER = ROOT / "notes/append_iteration_20260521T140826.py"

ENTRY_TS = "2026-05-21T14:08:26Z"
DATE_OUTPUT = "2026-05-21T14:08:26.069282018Z"
...
append(INDEX, index_row(
    "notes/append_iteration_20260521T140826.py",
...
validation_out = Path("/tmp/cassandra-artifact-index-current-hash-post-20260521T140826Z.json")
proc = subprocess.run(
...
final_out = Path("/tmp/cassandra-artifact-index-current-hash-final-20260521T140826Z.json")
