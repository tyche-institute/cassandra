#!/usr/bin/env python3
"""Append bounded same-date cadence iteration records for 2026-05-21T13:54:47Z.
...
HELPER = ROOT / "notes/append_iteration_20260521T135447.py"

ENTRY_TS = "2026-05-21T13:54:47Z"
DATE_OUTPUT = "2026-05-21T13:54:47.745686150Z"
...
append(INDEX, index_row(
    "notes/append_iteration_20260521T135447.py",
...
validation_out = Path("/tmp/cassandra-artifact-index-current-hash-post-20260521T135447Z.json")
proc = subprocess.run(
...
final_out = Path("/tmp/cassandra-artifact-index-current-hash-final-20260521T135447Z.json")
